      ...
      <div class="row pt-3">
        ...
        <div class="col-md-3 mb-3">
          ...
          <input
            ...
            min="0"
            class="form-control"
            :value="patchNoteForm.season"
            @input="update('season', Number(($event.target as HTMLInputElement).value))"
            required
          />
        </div>
        <div class="col-md-3 mb-3">
          ...
          <AppSelect
            :modelValue="patchNoteForm.type"
            :options="typeSelectOptions"
            placeholder="Pilih Tipe"
            @change="(val: string | number | null) => update('type', (val as PatchNoteFormData['type']) ?? 'MAJOR')"
          />
        </div>
        <div class="col-md-6 mb-3">
          ...
          <input
            type="date"
            class="form-control"
            :value="patchNoteForm.start_date"
        ...
        <div class="col-md-12 mb-3">
          <div class="form-check form-switch">
            <input
              ...
              type="checkbox"
              :checked="patchNoteForm.is_active"
