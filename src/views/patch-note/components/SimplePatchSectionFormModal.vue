...
const props = defineProps<{
  ...
  form: SimplePatchNoteSectionFormData;
...
const emit = defineEmits<{
  (e: 'submit'): void;
  (e: 'cancel'): void;
  (e: 'update:form', value: SimplePatchNoteSectionFormData): void;
}>();

const update = <K extends keyof SimplePatchNoteSectionFormData>(field: K, value: SimplePatchNoteSectionFormData[K]) =>
      ...
      <div class="pt-3">
        ...
        <div class="mb-3">
          ...
          <textarea
            ...
            @input="update('change_details', ($event.target as HTMLTextAreaElement).value)"
          ></textarea>
        </div>
      </div>
